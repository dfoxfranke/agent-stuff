...
description: "Decide whether unsafe Rust is justified and review its contracts and proof obligations. Use this skill when adding, changing, or reviewing Rust code involving unsafe blocks, unsafe functions or traits, unsafe impls, FFI, raw pointers, unchecked operations, low-level systems code, or performance-motivated unsafe code, even when the task does not explicitly ask about safety comments or documentation."
---
...
Do not treat a permissive repository policy, widespread existing unsafe code,
or the absence of an explicit restriction as permission to weaken this skill's
...
The `api-documentation-quality` and `api-documentation-quality-in-rust` skills
contain the related, broader API-documentation guidance.
